			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					<div class="single-cat-list">
						...
						<div class="overlay">
							<div class="text">Maltese Dog</div>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
				...
				<div class="col-lg-3 col-md-6">
					<div class="single-cat-list">
						...
						<div class="overlay">
							<div class="text">Yorkshire Terrier</div>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="single-cat-list">
						...
						<div class="overlay">
							<div class="text">French Bulldog</div>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
