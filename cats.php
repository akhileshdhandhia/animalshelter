		...
		<div class="container">
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p class="text-white link-nav"><a href="index.php">Home </a> <span class="lnr lnr-arrow-right"></span> <a href="cats.html"> Cats</a></p>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row">
				<div class="col-lg-3 col-md-6">
					<div class="single-cat-list">
						...
						<div class="overlay">
							<div class="text">Persian Cat</div>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="single-cat-list">
						...
						<div class="overlay">
							<div class="text">Russian Blue</div>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
				...
				<div class="col-lg-3 col-md-6">
					<div class="single-cat-list">
						...
						<div class="overlay">
							<div class="text">British Shorthair</div>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
				...
				<div class="col-lg-3 col-md-6">
					<div class="single-cat-list">
						...
						<div class="overlay">
							<div class="text"> &nbsp Munchkin Cat</div>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="single-cat-list">
						...
						<div class="overlay">
							<div class="text">Ragdoll Cat</div>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
